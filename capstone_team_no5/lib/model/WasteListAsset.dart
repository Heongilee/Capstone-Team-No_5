...
class WasteListAsset {
  ...
  final Map<String, WastePriceInfo> _trashList = {
    ...
    "bookshelf": WastePriceInfo("책장(책꽂이)", ['100cm 이상', '100cm 미만', '4단 이하', '2단 이하'], [8000, 5000, 4000, 2000]),
    ...
    "Ironing_board": WastePriceInfo("다림이판", ['모든 규격'], [1000]),
    "Audio_bench": WastePriceInfo("오디오장식장", ['모든 규격'], [3000]),
    "TV_stand": WastePriceInfo("TV 받침", ['모든 규격'], [3000]),
    "foodDesk": WastePriceInfo("밥상", ['4인 이상', '3인 이하'], [2000, 1000]),
    "Display_stand": WastePriceInfo("진열대", ['모든 규격'], [3000]),
    ...
    "glass": WastePriceInfo("유리(거울,판유리)", ['1㎡당'], [2000]),
    "wood": WastePriceInfo("기타 목재", ['5kg 당'], [2000]),
    ...
    "a_jade_mat": WastePriceInfo("옥매트", ['2인용', '1인용'], [7000, 4000]),
    "exhaust_hood": WastePriceInfo("배기후드", ['모든 규격'], [2000]),
    "icebox": WastePriceInfo("아이스박스", ['대형', '소형'], [2000, 1000]),
    "skis": WastePriceInfo("스키", ['모든 규격'], [2000]),
    "snowboard": WastePriceInfo("보드", ['모든 규격'], [2000])
  };
