...
class mainpage_text_editing_controller{
  ...
  // TODO : 체크박스 여부를 JSON타입으로 만들어서 Asset에 저장시킬 순 없을까?
  // 사이트 참고하기 : https://flutter.dev/docs/development/ui/assets-and-images
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text('Sign In', style: TextStyle(fontSize: 40.0, fontStyle: FontStyle.italic, fontWeight: FontWeight.w900),),
              ],
            ),
            ...
            Container(
              ...
              height: 40.0,
              child: InkWell(
                child: Text('Forget your ID or password?', style: TextStyle(decoration: TextDecoration.underline),),
                onTap: (){
